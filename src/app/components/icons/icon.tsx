...
export const iconFillColor = (theme: any) => "var(--icon-fill-color)";

const handlerColor = (theme: any) =>
  theme === "#1e1e1e";
...
export const GroupIcon = React.memo(({ theme }: { theme: any }) =>
  createIcon(
    <>
...
export const UngroupIcon = React.memo(({ theme }: { theme: any }) =>
  createIcon(
    <>
      <path d="M25 26H111V111H25" fill={iconFillColor(theme)} />
      <path
...
export const FillDashedIcon = createIcon(
  <>
    <g clipPath="url(#a)">
      <mask
        id="b"
...
export const TextAlignTopIcon = React.memo(({ theme }: { theme: any }) =>
  createIcon(
    <g
      strokeWidth="1.5"
      stroke="currentColor"
...
export const TextAlignBottomIcon = React.memo(({ theme }: { theme: any }) =>
  createIcon(
    <g
      strokeWidth="2"
      stroke="currentColor"
...
export const TextAlignMiddleIcon = React.memo(({ theme }: { theme: any }) =>
  createIcon(
    <g
      strokeWidth="1.5"
      stroke="currentColor"
